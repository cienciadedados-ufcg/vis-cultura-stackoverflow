...
dados %>%
    ...
    geom_point(alpha = .6)+
    theme(plot.title = element_text(size = 12,face="bold",family="Lobster")) +
    labs(
        title = "Relação entre os Usuários, seus comentários, PDI e acesso à Internet",
        position="plot",
        y = "Porcentagem de usuários que comentam",
...
Análise de gŕafico 2
A segunda análise que faremos é baseada no **excesso de cores em um gráfico**. Estudos mostram que o excesso de cor pode confundir o visualizador.
...
Análise de gŕafico 3
A terceira análise que faremos é baseada no **escolha das variáveis**. 
